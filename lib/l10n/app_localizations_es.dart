...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get pleaseLoginToSearch =>
      'Inicie sesión para utilizar la función de búsqueda.';

  @override
  String get searchHint => 'Buscar versículos, suras...';

  @override
  String get accessUnlockMoreTafsirs => 'Desbloquea más Tafsirs';

  @override
  String get accessCloudTafsirsDesc =>
      'Acceda a los Tafsirs en la nube (de la Fundación Corán) directamente en su idioma.';

  @override
  String get signIn => 'Iniciar sesión';

  @override
  String get welcomeToAlQuran => 'Bienvenido a Al-Quran';

  @override
  String get quranFoundationSyncDesc =>
      'Conéctese con la Fundación Corán para sincronizar sus marcadores, notas y progreso de lectura en todos sus dispositivos.';

  @override
  String get loginWithQuranFoundation =>
      'Iniciar sesión con la Fundación Corán';
}
