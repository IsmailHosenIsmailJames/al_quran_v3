...
class AppColors {
  static Color primary = const Color(0xff1E9579);
  static Color primaryDark = const Color.fromARGB(255, 65, 77, 74);
  static Color primaryShade100 = primary.withValues(alpha: 0.1);
  static Color primaryShade200 = primary.withValues(alpha: 0.2);
  static Color primaryShade300 = primary.withValues(alpha: 0.3);
