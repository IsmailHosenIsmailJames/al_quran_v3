Map<String, List<Map<String, dynamic>>> tafsirResources = {
  "Sinhala_Sinhalese": [
    {
  ...
  "Bengali": [
    {
      ...
      "language_code": "bn",
      "name": "কুরআনের সংক্ষিপ্ত ব্যাখ্যা",
  ...
  "Turkish": [
    ...
    },
    {
      ...
      "english_name": "Turkish Al-Mukhtasar in Interpreting the Noble Quran",
      "file_name":
  ...
  "Arabic": [
    ...
    },
    {
      ...
      "english_name": "Arabic Al-Mukhtasar in interpreting the Noble Quran",
      "file_name":
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "أيسر التفاسير لأبي بكر الجزائري",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "إعراب القرآن الكريم وبيانه للدرويش",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "نظم الدرر في تناسب الآيات والسور للبقاعي",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "إعراب القرآن الكريم لدعاس",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "إعراب القرآن (الرسم الشجري)",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "الموسوعة القرآنية للقراءات",
    ...
    },
    {
      ...
      "language_native": "العربية",
      "language_code": "ar",
      "name": "الدر المصون للسمين الحلبي",
  ...
  "Urdu": [
    ...
    },
    {
      ...
      "language_native": "اردو",
      "language_code": "ur",
      "name": "تذکیر القرآن (مولانا وحید الدین خان)",
      "english_name": "Tazkirul Quran(Maulana Wahiduddin Khan)",
      "file_name": "Tazkirul_Quran(Maulana_Wahiduddin_Khan).json.txt",
      "full_path":
  ...
  "Italian": [
    {
      ...
      "english_name": "Italian Al-Mukhtasar in interpreting the Noble Quran",
      "file_name":
  ...
  "Vietnamese": [
    {
      ...
      "language_code": "vi",
      "name": "Al-Mukhtasar trong việc giải thích Kinh Quran",
      "english_name": "Vietnamese Al-Mukhtasar in interpreting the Noble Quran",
      "file_name":
  ...
  "Persian": [
    {
      ...
      "english_name": "Persian Al-Mukhtasar in interpreting the Noble Quran",
      "file_name":
  ...
  "Indonesian": [
    {
      ...
      "english_name": "Indonesian Al-Mukhtasar in Interpreting the Noble Quran",
      "file_name":
  ...
  "Kyrgyz_kirghiz": [
    {
      "language": "Kyrgyz_kirghiz",
      "language_native": "Кыргызча",
      "language_code": "ky",
      "name": "Мухтасар Куран тафсири",
