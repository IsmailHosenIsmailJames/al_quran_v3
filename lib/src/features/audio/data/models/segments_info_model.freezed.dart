...
class _SegmentsInfoModel extends SegmentsInfoModel {
  const _SegmentsInfoModel({@JsonKey(name: 'surah_number') this.surahNumber, @JsonKey(name: 'ayah_number') this.ayahNumber, @JsonKey(name: 'audio_url') this.audioUrl, this.duration, final  List<List<int>>? segments}): _segments = segments,super._();
