...
String getTheTimeKey(
  ...
  if (distanceInDay > 365) {
    timeKey = l10n.oneYearAgo;
  } else if (distanceInDay > 182) {
    timeKey = l10n.monthsAgo(localizedNumber(context, 6));
  } else if (distanceInDay > 91) {
    timeKey = l10n.monthsAgo(localizedNumber(context, 3));
  } else if (distanceInDay > 60) {
    timeKey = l10n.monthsAgo(localizedNumber(context, 2));
  } else if (distanceInDay > 30) {
    timeKey = l10n.monthsAgo(localizedNumber(context, 1));
  } else if (distanceInDay > 21) {
    timeKey = l10n.weeksAgo(localizedNumber(context, 3));
  } else if (distanceInDay > 14) {
    timeKey = l10n.weeksAgo(localizedNumber(context, 2));
  } else if (distanceInDay > 7) {
    timeKey = l10n.weeksAgo(localizedNumber(context, 1));
  } else if (distanceInDay > 6) {
    timeKey = l10n.daysAgo(localizedNumber(context, 6));
  } else if (distanceInDay > 5) {
    timeKey = l10n.daysAgo(localizedNumber(context, 5));
  } else if (distanceInDay > 4) {
    timeKey = l10n.daysAgo(localizedNumber(context, 4));
  } else if (distanceInDay > 3) {
    timeKey = l10n.daysAgo(localizedNumber(context, 3));
  } else if (distanceInDay > 2) {
    timeKey = l10n.daysAgo(localizedNumber(context, 2));
  } else if (distanceInDay > 1) {
    timeKey = l10n.daysAgo(localizedNumber(context, 1));
  } else {
    timeKey = l10n.today;
  }
  return timeKey;
