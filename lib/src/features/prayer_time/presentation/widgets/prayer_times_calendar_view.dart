...
class _PrayerTimesCalenderViewState extends State<PrayerTimesCalenderView> {
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  _buildHeaderCell(l10n.dateAndHijri, 130, isDark, themeState),
                                  ...prayers.map(
  ...
  Widget _buildHeaderCell(String title, double width, bool isDark, dynamic themeState) {
    return SizedBox(
      width: width,
      child: Center(
        child: Text(
