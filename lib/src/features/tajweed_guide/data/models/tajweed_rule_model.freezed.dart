...
@pragma('vm:prefer-inline') @override $Res call({Object? arabicText = null,Object? transliteration = null,Object? surahAyahRef = freezed,Object? surahNumber = freezed,Object? ayahNumber = freezed,Object? wordIndex = freezed,}) {
  return _then(TajweedExampleModel(
...
class _TajweedRuleModel extends TajweedRuleModel {
  const _TajweedRuleModel({required this.id, required this.ruleKey, required this.name, required this.arabicName, required this.description, required this.howToPronounce, required  List<TajweedExampleModel> examples, required this.lightColor, required this.darkColor}): _examples = examples,super._();
