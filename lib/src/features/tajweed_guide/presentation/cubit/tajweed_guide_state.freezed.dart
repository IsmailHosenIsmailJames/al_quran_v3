...
class TajweedGuideLoaded implements TajweedGuideState {
  const TajweedGuideLoaded({required  List<TajweedRuleEntity> rules, required  List<TajweedRuleEntity> filteredRules, this.searchQuery = ""}): _rules = rules,_filteredRules = filteredRules;
