...
class _HizbModel extends HizbModel {
  const _HizbModel({@JsonKey(name: 'hn') required this.hizbNumber, @JsonKey(name: 'vc') required this.versesCount, @JsonKey(name: 'fvk') required this.firstVerseKey, @JsonKey(name: 'lvk') required this.lastVerseKey, @JsonKey(name: 'vm') required  Map<String, String> verseMapping}): _verseMapping = verseMapping,super._();
