...
class RukuListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      ...
      builder: (context, asyncSnapshot) {
        ...
        final List<RukuInfoModel> rukuInfoList = metaDataRuku.values
        ...
        if (isTabletGrid) {
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildRukuCard(
                context: context,
                index: index,
                rukuInfoList: rukuInfoList,
                l10n: l10n,
  ...
  Widget _buildRukuCard({
    required BuildContext context,
    required int index,
    required List<RukuInfoModel> rukuInfoList,
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${l10n.ruku} ${localizedNumber(context, index + 1)}",
                        style: TextStyle(
                          fontSize: 16,
