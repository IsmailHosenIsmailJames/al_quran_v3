...
class _ResourceGroupEntity implements ResourceGroupEntity {
  const _ResourceGroupEntity({required this.languageKey, required this.languageNative, required this.languageEnglish, required final  List<QuranResourceEntity> resources}): _resources = resources;
