...
class QuranResourcesScreen extends StatefulWidget {
  final int initTab;
  const QuranResourcesScreen({super.key, this.initTab = 0});

  @override
  State<QuranResourcesScreen> createState() => _QuranResourcesScreenState();
}

class _QuranResourcesScreenState extends State<QuranResourcesScreen>
