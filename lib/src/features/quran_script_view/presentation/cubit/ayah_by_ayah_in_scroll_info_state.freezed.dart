...
class _AyahByAyahInScrollInfoState implements AyahByAyahInScrollInfoState {
  const _AyahByAyahInScrollInfoState({this.surahInfoModel, final  List<String>? expandedForWordByWord, this.isAyahByAyah = true, final  List<int>? pageByPageList, this.dropdownAyahKey}): _expandedForWordByWord = expandedForWordByWord,_pageByPageList = pageByPageList;
