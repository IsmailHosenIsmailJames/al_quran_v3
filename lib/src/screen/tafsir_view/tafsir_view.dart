      ...
      body: TabBarView(
        ...
        children: List<Widget>.generate(tafsirBookList.length, (index) {
          return FutureBuilder(
            future: QuranTafsirFunction.getTafsirForBook(
              tafsirBookList[index],
              widget.ayahKey,
            ),
            builder: (context, snapshot) {
              ...
              if (parts?.length == 2 &&
                ...
                if (text != null) tafsirDataString = text;
              }

              tafsirDataString = tafsirDataString.toString().replaceAll(
                '"',
                "",
              );
