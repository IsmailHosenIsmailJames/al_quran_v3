...
translations = {
    ...
    "accessUnlockMoreTafsirs": {
        "ar": "افتح المزيد من التفاسير", "az": "Daha çox Təfsirə daxil olun", "bn": "আরও তাফসীর অ্যাক্সেস ও আনলক করুন", "de": "Schalten Sie weitere Tafsire frei", "en": "Access More Tafsirs", "es": "Desbloquea más Tafsirs", "fa": "دسترسی به تفاسیر بیشتر", "fr": "Débloquez plus de Tafsirs", "hi": "अधिक Tafsirs अनलॉक करें", "id": "Buka Lebih Banyak Tafsir", "it": "Sblocca altri Tafsir", "ja": "さらに多くのタフシールをアンロック", "kk": "Көбірек тәпсірлерді көру", "ko": "더 많은 타프시르 보기", "ms": "Buka Lebih Banyak Tafsir", "pa": "ਹੋਰ ਤਫ਼ਸੀਰਾਂ ਤੱਕ ਪਹੁੰਚ ਕਰੋ", "ps": "نورو تفاسیرو ته لاسرسی", "pt": "Desbloqueie mais Tafsirs", "ru": "Разблокировать больше Тафсиров", "sw": "Pata Tafsiri Zaidi", "ta": "மேலும் பல தஃப்சீர்களை அணுகவும்", "tr": "Daha Fazla Tefsir Aç", "ur": "مزید تفاسیر کھولیں", "vi": "Truy cập thêm nhiều Tafsir", "zh": "解锁更多塔夫西尔"
    },
    "accessCloudTafsirsDesc": {
        "ar": "احصل على تفاسير السحابية (من مؤسسة القرآن) مباشرة بلغتك.", "az": "Keltirilmiş bulud Təfsirlərinə (Quran Fondundan) birbaşa öz dilinizdə daxil olun.", "bn": "সরাসরি আপনার ভাষায় ক্লাউড তাফসীর (কুরআন ফাউন্ডেশন থেকে) অ্যাক্সেস করুন।", "de": "Greifen Sie direkt in Ihrer Sprache auf Cloud-Tafsire (von der Quran Foundation) zu.", "en": "Access cloud Tafsirs (From Quran Foundation) directly in your language.", "es": "Acceda a los Tafsirs en la nube (de la Fundación Corán) directamente en su idioma.", "fa": "دسترسی مستقیم به تفاسیر ابری (از بنیاد قرآن) به زبان خودتان.", "fr": "Accédez aux Tafsirs en ligne (de la Fondation Coran) directement dans votre langue.", "hi": "सीधे अपनी भाषा में ক্লাउड Tafsirs (कुरान फाउंडेशन से) एक्सेस करें।", "id": "Akses Tafsir awan (dari Quran Foundation) langsung dalam bahasa Anda.", "it": "Accedi ai Tafsir cloud (della Quran Foundation) direttamente nella tua lingua.", "ja": "あなたの言語でクラウド・タフシール（コーラン財団提供）に直接アクセス。", "kk": "Бұлттық тәпсірлерге (Құран қорынан) тікелей өз тіліңізде қол жеткізіңіз.", "ko": "원하는 언어로 클라우드 타프시르(꾸란 재단 제공)를 직접 확인하세요.", "ms": "Akses Tafsir awan (daripada Yayasan Al-Quran) secara langsung dalam bahasa anda.", "pa": "ਸਿੱਧੇ ਆਪਣੀ ਭਾਸ਼ਾ ਵਿੱਚ ਕਲਾਉਡ ਤਫ਼ਸੀਰਾਂ (ਕੁਰਾਨ ਫਾਊਂਡੇਸ਼ਨ ਤੋਂ) ਤੱਕ ਪਹੁੰਚ ਕਰੋ।", "ps": "په مستقیم ډول ستاسو په ژبه کې د بادل تفاسیرو (د قران بنسټ څخه) ته لاسرسی ومومئ.", "pt": "Acesse os Tafsirs na nuvem (da Fundação Alcorão) diretamente em seu idioma.", "ru": "Получите доступ к облачным Тафсирам (от Фонда Корана) прямо на вашем языке.", "sw": "Pata Tafsiri za wingu (Kutoka Quran Foundation) moja kwa moja kwa lugha yako.", "ta": "உங்கள் மொழியிலேயே கிளவுட் தஃப்சீர்களை (குர்ஆன் அறக்கட்டளையிலிருந்து) நேரடியாக அணுகவும்.", "tr": "Kendi dilinizde bulut Tefsirlere (Kuran Vakfı'ndan) doğrudan erişin.", "ur": "براہ راست اپنی زبان میں کلاؤড تفاسیر (قرآن فاؤنڈیشن से) تک رسائی حاصل کریں۔", "vi": "Truy cập trực tiếp các Tafsir đám mây (từ Quran Foundation) bằng ngôn ngữ của bạn.", "zh": "直接以您的语言访问云端塔夫西尔（来自古兰经基金会）。"
    },
    "signIn": {
        "ar": "تسجيل الدخول", "az": "Daxil ol", "bn": "সাইন ইন", "de": "Anmelden", "en": "Sign In", "es": "Iniciar sesión", "fa": "ورود", "fr": "Se connecter", "hi": "साइन इन करें", "id": "Masuk", "it": "Accedi", "ja": "サインイン", "kk": "Кіру", "ko": "로그인", "ms": "Log Masuk", "pa": "ਸਾਈਨ ਇਨ", "ps": "ننوځئ", "pt": "Entrar", "ru": "Войти", "sw": "Ingia", "ta": "உள்நுழைக", "tr": "Giriş Yap", "ur": "سائن ان کریں", "vi": "Đăng nhập", "zh": "登录"
    }
}
